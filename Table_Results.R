...
png(
  filename = "D:\\MSE_Run\\MSE_Results\\Plots\\Barplot_Decision_Table.png",
  type = "cairo",
  units = "mm",
  width = 300,
  height = 325,
...
tiff(
  filename = "D:\\MSE_Run\\MSE_Results\\Plots\\Barplot_Decision_Table.tiff",
  type = "cairo",
  units = "mm",
  width = 300,
  height = 325,
...
png(
  filename = "D:\\MSE_Run\\MSE_Results\\Plots\\Barplot_Decision_Table_SKINNY.png",
  type = "cairo",
  units = "mm",
  width = 300,
  height = 150,
...
#####
par(mfrow = c(3, 6), mar = c(0, 0, 0, 0), tcl = -0.1, mgp = c(0.5, 0, 0.01), cex = 1, oma = c(2.5, 2, 2, 0.1))
...
barplot(as.table(rbind(Med_TotComCatch_C[1:4], Med_TotComCatch_L[1:4], Med_TotComCatch_H[1:4])),
  beside = T, col = c("grey", "dodgerblue", "red"), border = NA,
  # density=c(-1, -1, -1, -1, -1, -1, 50,50,50,50,50,50),
  ylim = c(0, 17000), ylab = NULL, names.arg = NULL, axisnames = T, axes = F, cex.names = 0.5
)
axis(2, cex.axis = 0.5)
axis(1, labels = F, cex.axis = 0.5)
box()
mtext("US Catch", 2, line = 0.75, cex = 0.7)
for (i in seq(5, 21, by = 4)) {
  barplot(as.table(rbind(Med_TotComCatch_C[i:(i + 3)], Med_TotComCatch_L[i:(i + 3)], Med_TotComCatch_H[i:(i + 3)])),
    beside = T, col = c("grey", "dodgerblue", "red"), border = NA,
    ylim = c(0, 17000), ylab = NULL, axisnames = T, axes = F, cex.names = 0.5
  )
  axis(2, labels = F)
  axis(1, labels = F, cex.axis = 0.5)
  box()
