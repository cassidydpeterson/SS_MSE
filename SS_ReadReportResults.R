...
MANIP_RESULTS <- function(OM_Plot, OM_Name, hlist=1:24, plot=TRUE){
 ...
 Tot_Catch_cumulative <- as.data.frame(Tot_Catch_cumulative)
  ...
  if(plot==TRUE){
    ...
    ## AAV ##
    png(filename=paste0("D:\\MSE_Run\\MSE_Results\\Plots\\",OM_Name,"_VIOLIN_AAV.png"),
        type="cairo",
        units="mm",
        width=300,
        height=225,
    ...
    ## POF ##
    png(filename=paste0("D:\\MSE_Run\\MSE_Results\\Plots\\",OM_Name,"_VIOLIN_POF.png"),
        type="cairo",
        units="mm",
        width=300,
        height=225,
...
D:\MSE_Run\MSE_Results

OM_lnR0$HCR_23$SSB[nrow(OM_lnR0$HCR_23$SSB),]

MANIP_RESULTS(OM_Plot=OM_Base_Concept, OM_Name="Base_Concept", plot=FALSE)
